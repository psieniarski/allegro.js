...
Client.prototype.getCategoryFields = function(categoryId, callback) {
    var self = this;
    self._soapClient.doGetSellFormFieldsForCategory({
        webapiKey: this._key,
        countryId: this._countryId,
        ...
        if (err) {
            ...
            callback(null, result.sellFormFieldsForCategory.sellFormFieldsList[0].item, self);
        }
    });
}
